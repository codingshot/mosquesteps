...
export const guides: Guide[] = [
  ...
  },
  {
    ...
    iconEmoji: "🚶",
    description: "Start a real-time walking session with GPS tracking, step counting, turn-by-turn directions, live calories, and milestone voice announcements.",
    screenshot: guideActiveWalk,
    steps: [
      { text: "Tap the Walk button (center) in the bottom navigation bar.", link: "/walk", linkLabel: "Start Walking" },
      { text: "Select which prayer you're walking for — Fajr, Dhuhr, Asr, Maghrib, Isha, or Jumuah. The prayer time and 'Leave by' time are shown instantly." },
      { text: "If no mosque is selected, tap 'Find Mosque' before starting. With a mosque set, you get turn-by-turn directions and an arrival margin estimate.", link: "/mosques", linkLabel: "Find a Mosque" },
      { text: "Tap 'Start Walking' — the app begins tracking via GPS and device motion sensors. A 'Steps are counting' banner confirms the sensor is active." },
      { text: "Watch steps, distance, time, hasanat (✦), and live calories update in real time on the stats row." },
      { text: "A Moving / Stationary / Auto-paused status indicator shows your current movement state with speed in km/h. The step counter auto-pauses after 60 seconds stationary and resumes when you move." },
      { text: "Voice announcements celebrate progress at 25%, 50%, and 75% of the route with distance remaining and estimated arrival time. A gentle double-vibration confirms each milestone." },
      { text: "Follow turn-by-turn directions at the top of the screen. Voice guidance announces each turn and a 'Prepare to turn' alert fires within 50m. If you go off-route, the app auto-reroutes." },
      { text: "The map rotates to match your heading (POV mode) using your device compass or route bearing. A GPS signal strength indicator (Weak / Fair / Strong) is shown." },
      { text: "At the end of the walk, tap 'End Walk'. The completion screen shows your steps, hasanat, distance, calories, and any new Personal Best 🏅. Your walk is saved to History.", link: "/history", linkLabel: "View History" },
    ],
    tip: "No GPS? Steps still count via motion sensors and you can navigate directions manually using the ◀ ▶ buttons. Your current streak is shown on the pre-walk screen to keep you motivated!",
    page: "/walk",
