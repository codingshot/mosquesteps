...
const guides = [
  {
    ...
    steps: [
      ...
      "Tap the Settings icon to configure your city — this ensures accurate prayer times even without GPS.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Tap 'Start Walking' — the app will begin tracking via GPS and device sensors.",
